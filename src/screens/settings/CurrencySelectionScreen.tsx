...
export const CurrencySelectionScreen = () => {
    ...
    const renderItem = ({ item }: { item: Currency }) => {
        ...
        return (
            ...
            >
                <View style={[styles.iconContainer, { backgroundColor: isSelected ? theme.colors.primary + '20' : theme.colors.background }]}>
                    <Text style={[styles.symbol, { color: isSelected ? theme.colors.primary : theme.colors.text }]}>
                        {item.symbol}
                    </Text>
                </View>
