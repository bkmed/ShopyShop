...
export const CurrencyAdminScreen = () => {
    ...
    const [form, setForm] = useState<Omit<Currency, 'id' | 'createdAt' | 'updatedAt'>>({
        code: '',
        symbol: '',
        rate: 1,
        isBase: false,
        ...
        <View style={[styles.card, { backgroundColor: theme.colors.surface }]}>
            <View style={styles.cardHeader}>
                <View>
                    <Text style={[styles.cardCode, { color: theme.colors.text }]}>
                        {item.code} {item.isBase && <Text style={{ color: theme.colors.primary, fontSize: 12 }}>(Base)</Text>}
                    </Text>
                    <Text style={[styles.cardSymbol, { color: theme.colors.subText }]}>{item.symbol}</Text>
                </View>
            ...
            <View style={[styles.cardStats, { borderTopColor: theme.colors.border }]}>
                <View style={styles.statItem}>
                    <Text style={[styles.statLabel, { color: theme.colors.subText }]}>Rate</Text>
                ...
                <View style={styles.statItem}>
                    ...
                    <Text style={[styles.statValue, { color: item.isActive ? theme.colors.success : theme.colors.error }]}>
            ...
            <FlatList
                ...
                ListHeaderComponent={() => (
                    <View style={styles.header}>
                        <Text style={[styles.title, { color: theme.colors.text }]}>Currency Management</Text>
                        ...
                        <View style={[styles.form, { backgroundColor: theme.colors.surface }]}>
                            ...
                            <View style={styles.formRow}>
                                <View style={styles.formGroup}>
                                    <Text style={[styles.label, { color: theme.colors.subText }]}>Code</Text>
                                    <TextInput
                                ...
                                <View style={styles.formGroup}>
                                    <Text style={[styles.label, { color: theme.colors.subText }]}>Symbol</Text>
                                    <TextInput
                                        style={[styles.input, { color: theme.colors.text, borderColor: theme.colors.border }]}
                                        placeholder="€"
                                        value={form.symbol}
                            ...
                            <View style={styles.formRow}>
                                <View style={styles.formGroup}>
                                    <Text style={[styles.label, { color: theme.colors.subText }]}>Rate</Text>
                                    <TextInput
                                        style={[styles.input, { color: theme.colors.text, borderColor: theme.colors.border }]}
                                        placeholder="1.0"
                                        keyboardType="numeric"
                                        value={form.rate.toString()}
                                        onChangeText={text => setForm({ ...form, rate: parseFloat(text) || 0 })}
                                    />
                                </View>
                                <View style={styles.formGroupCenter}>
                                    <Text style={[styles.label, { color: theme.colors.subText }]}>Base</Text>
                                    <Switch
                                        value={form.isBase}
                                ...
                                <View style={styles.formGroupCenter}>
                                    <Text style={[styles.label, { color: theme.colors.subText }]}>Active</Text>
                                    <Switch
                                        value={form.isActive}
                            ...
                            <View style={styles.formActions}>
                                ...
                                <TouchableOpacity
                                    ...
                                    onPress={handleSave}
                                >
                                    <Text style={styles.saveBtnText}>{editingId ? 'Update' : 'Add Currency'}</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                    </View>
