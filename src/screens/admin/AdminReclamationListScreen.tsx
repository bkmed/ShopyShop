...
export const AdminReclamationListScreen = () => {
    ...
    const renderItem = ({ item }: { item: Reclamation }) => (
        <TouchableOpacity
            ...
            onPress={() => navigation.navigate('AdminReclamationDetail', { reclamationId: item.id })}
        >
    ...
    return (
        <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
            <GlassHeader title={t('admin.reclamations.title') || 'Reclamation Management'} />
                ...
                ListEmptyComponent={
                    <View style={styles.empty}>
                        <Text style={[styles.emptyText, { color: theme.colors.subText }]}>
                            {t('admin.reclamations.noReclamations') || 'No reclamations found'}
                        </Text>
                    </View>
                }
            />
