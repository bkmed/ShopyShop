    ...
    const renderItem = ({ item }: { item: Product }) => (
        ...
        >
            ...
            <View style={{ flex: 1 }}>
                ...
                <Text style={[styles.sku, { color: theme.colors.subText }]}>SKU: {item.id}</Text>
            </View>
            <View style={styles.stockInfo}>
                ...
                <Text style={[styles.unit, { color: theme.colors.subText }]}>{t('inventory.units') || 'Units'}</Text>
            </View>
        </TouchableOpacity>
    );
    ...
    return (
        <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
            <View style={styles.header}>
                <Text style={[styles.title, { color: theme.colors.text }]}>{t('navigation.inventory')}</Text>
                <TouchableOpacity
