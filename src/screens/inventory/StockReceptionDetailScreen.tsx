      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={[styles.card, { backgroundColor: theme.colors.surface }]}>
          ...
          <View style={styles.row}>
            <View style={{ flex: 1 }}>
              <Text style={[styles.label, { color: theme.colors.subText }]}>
                {t('stockReception.status')}
              </Text>
              <Text style={[styles.value, { color: theme.colors.text }]}>
                {t(`stockReception.${reception.status}`)}
              </Text>
            </View>
            <View style={{ flex: 1 }}>
              <Text style={[styles.label, { color: theme.colors.subText }]}>
                {t('stockReception.receivedDate')}
              </Text>
              <Text style={[styles.value, { color: theme.colors.text }]}>
                {reception.receivedDate
                  ? new Date(reception.receivedDate).toLocaleDateString()
                  : '-'}
              </Text>
            </View>
          </View>
        ...
        {reception.items.map(item => (
          ...
          >
            ...
            <View style={styles.itemRow}>
              <View style={{ flex: 1 }}>
                <Text
                  style={[styles.itemLabel, { color: theme.colors.subText }]}
                >
                  {t('stockReception.expectedQuantity')}
                </Text>
              ...
              <View style={{ flex: 1 }}>
                <Text
                  style={[styles.itemLabel, { color: theme.colors.subText }]}
                >
                  {t('stockReception.receivedQuantity')}
                </Text>
                <TextInput
                  style={[
                    styles.qtyInput,
