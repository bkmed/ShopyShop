...
export const CategoryDetailScreen = () => {
    ...
    const handleDelete = () => {
        Alert.alert(
            ...
            t('categories.deleteConfirm') || 'Are you sure you want to delete this category?',
            [
    ...
    if (!category) {
        return (
            <View style={[styles.centered, { backgroundColor: theme.colors.background }]}>
                <Text style={{ color: theme.colors.subText }}>{t('categories.noCategories')}</Text>
            </View>
        );
    }
        ...
        <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
            ...
            <View style={styles.content}>
                ...
                <View style={styles.actions}>
                    <TouchableOpacity
                        style={[styles.editButton, { borderColor: theme.colors.primary, borderWidth: 1 }]}
