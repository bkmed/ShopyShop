...
export const CategoryAddScreen = () => {
    ...
    const handleSave = async () => {
        if (!form.name.trim()) {
            Alert.alert(t('common.error'), t('categories.nameRequired') || 'Category name is required');
            return;
        }
        ...
        try {
            if (editingCategory) {
                ...
                Alert.alert(t('common.success'), t('categories.updatedSuccessfully') || 'Category updated successfully');
            } else {
                await categoriesDb.add(categoryData);
                Alert.alert(t('common.success'), t('categories.savedSuccessfully') || 'Category saved successfully');
            }
            navigation.goBack();
        } catch (error) {
