        ...
        <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
                            ...
                            <View style={{ flex: 1 }}>
                                {method.type === 'card' && (
                                    <>
                                        ...
                                        <Text style={[styles.methodDetail, { color: theme.colors.subText }]}>
                                ...
                                {method.type === 'paypal' && (
                                    <>
                                        <Text style={[styles.methodName, { color: theme.colors.text }]}>PayPal</Text>
                                        <Text style={[styles.methodDetail, { color: theme.colors.subText }]}>
                                            {method.paypalEmail}
                                        </Text>
                                    </>
            ...
            <View style={styles.securityNote}>
                ...
                <Text style={[styles.securityText, { color: theme.colors.subText }]}>
                    {t('checkout.securityNote') || 'Your payment information is encrypted and secure'}
                </Text>
            </View>
        </ScrollView>
    );
