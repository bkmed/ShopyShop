...
export const PurchaseDetailScreen = () => {
    ...
    const renderItem = (item: OrderItem, index: number) => (
        <View key={index} style={[styles.itemRow, { borderBottomColor: theme.colors.border }]}>
            <View style={{ flex: 1 }}>
    ...
    return (
        ...
        >
            <View style={[styles.header, { backgroundColor: theme.colors.primary }]}>
                ...
                <Text style={styles.headerStatus}>{t(`orders.${order.status}`).toUpperCase()}</Text>
            </View>
            ...
            <View style={styles.content}>
                ...
                <TouchableOpacity
                    style={[styles.reportButton, { borderColor: '#FF4444', borderWidth: 1 }]}
                    onPress={() => navigation.navigate('ReclamationAdd', { orderId: order.id })}
                >
