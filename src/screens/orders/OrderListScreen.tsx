    ...
    const renderItem = ({ item }: { item: Order }) => (
        ...
        >
            <View style={styles.headerRow}>
                <Text style={[styles.orderId, { color: theme.colors.text }]}>#{item.id}</Text>
                <Text style={[styles.status, { color: theme.colors.primary }]}>{item.status.toUpperCase()}</Text>
            </View>
            <View style={styles.infoRow}>
                <Text style={[styles.date, { color: theme.colors.subText }]}>{item.createdAt}</Text>
    ...
    return (
        <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
            <View style={styles.header}>
                <Text style={[styles.title, { color: theme.colors.text }]}>{t('navigation.orders')}</Text>
                {user?.role === 'admin' && (
                    <TouchableOpacity
