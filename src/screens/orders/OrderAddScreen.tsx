...
export const OrderAddScreen = () => {
    ...
    const handleCreate = async () => {
        if (!form.totalAmount || !form.shippingAddress) {
            Alert.alert(t('common.error'), t('common.errorEmptyFields') || 'Please fill required fields');
            return;
        }
        ...
        try {
            ...
            Alert.alert(t('common.success'), t('orders.created') || 'Order created successfully');
            navigation.goBack();
        } catch (error) {
        ...
        >
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <View style={styles.formGroup}>
                    <Text style={[styles.label, { color: theme.colors.subText }]}>{t('orders.totalAmount')}</Text>
                    <TextInput
                ...
                <View style={styles.formGroup}>
                    <Text style={[styles.label, { color: theme.colors.subText }]}>{t('orders.shippingAddress')}</Text>
                    <TextInput
