    ...
    return (
        <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
            ...
            <View style={[styles.form, { backgroundColor: theme.colors.surface }]}>
                ...
                <TextInput
                    style={[styles.input, { color: theme.colors.text, borderColor: theme.colors.border, borderWidth: 1 }]}
                ...
                <Text style={[styles.label, { color: theme.colors.text, marginTop: 20 }]}>
                    {t('reclamations.description')}
                </Text>
                <TextInput
                    style={[styles.textArea, { color: theme.colors.text, borderColor: theme.colors.border, borderWidth: 1 }]}
