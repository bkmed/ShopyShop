...
class StockAlertService {
     ...
     */
    private async sendZeroStockAlert(productId: string, productName: string): Promise<void> {
    ...
    private async sendLowStockAlert(
        ...
        try {
            ...
            this.alertedProducts.add(alertKey);
            console.log(`Low stock alert sent for product: ${productName} (${currentStock} units)`);
        } catch (error) {
